...
{(In progress) September 2012 - April 2015}
{Portland State University}
{Portland, OR}	
...
\begin{itemize}
    ...
    \resitem
    {\textbf{Familiar:} Go, Ruby/Rails, Flask, atom-shell, sh, MySQL, SQLite, Assembly, C/autotools, regex, }
    \resitem
    {\textbf{On the Radar:} Haskell, Rust, Postgres, LevelDB, Puppet, Docker/Rocket, NixOS}
\end{itemize}
