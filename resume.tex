...
\begin{itemize}
    \resitem
    {\textbf{Fluent:} Windows, OS X, Unix, Git, HTML, IRC, Mathematica, LabVIEW, Arduino, \LaTeX, rbenv/rvm, gem, pip, github, bundler, jekyll, ssh}
    \resitem
    {\textbf{Almost There:} CSS, JavaScript/Node.js, Python, SVN, Vim, C, virtualenv, travis-ci, rake}
    \resitem
    {\textbf{Still Getting Started:} Ruby, Haskell, MatLab, Go, Shell Scripts, Assembly, SVN, SQL, MongoDB, Puppet, Ansible}
\end{itemize}
...
\item
\ressubheading
{Various IndieWebCamp Demos}
{2013}
{IndieWebCamp and OSFW3C}
{Portland \& San Francisco}
\begin{itemize}
    \resitem
    {Presented Demos of my IndieWeb Projects at OSFW3C, IndieWebCamp 2013 and various hack session in Portland discussing tools and standards that could help enable the decentralized social web.}
\end{itemize}
