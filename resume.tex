...
\item
\ressubheading{PSU Office of Information Technology}
{May 2013 - Present}
...
\item
\ressubheading{PSU S\'anchez Nano Development Lab}
{May 2013 - Present}
...
% Teachers Assistant
	\item
		\ressubheading{Teachers Assistant}{September 2012 - Present}{Portland State University}{Portland, OR}
		\begin{itemize}
...
% Languages
	...
	\begin{itemize}
		\resitem{\textbf{Fluent:} Windows, OS X, Unix, Git, HTML, IRC, Mathematica, LabVIEW, Arduino, \LaTeX, rbenv/rvm, gem, pip, github, bundler, jekyll}
